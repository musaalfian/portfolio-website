...
const principles = [
  {
    ...
    description: 'Saya mengutamakan pemahaman masalah operasional sebelum menulis kode. Solusi terbaik menyasar akar masalah, bukan gejalanya.',
    icon: 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z',
  },
  {
    title: 'Desain Sistem',
    description: 'Saya merancang struktur data dan alur kerja yang jelas sebelum implementasi. Arsitektur yang baik mencegah utang teknis.',
    icon: 'M19.428 15.428a2 2 0 00-1.022-.547l-2.384-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z',
  },
  {
    title: 'Implementasi',
    description: 'Saya menulis kode yang bersih dan mudah dirawat dengan abstraksi yang tepat. Kode lebih sering dibaca daripada ditulis.',
    icon: 'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4',
  },
  {
    title: 'Keandalan',
    description: 'Saya menekankan keandalan melalui pengujian, pemantauan, dan penanganan error yang cermat. Masalah di produksi memberi pelajaran paling berharga.',
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <h2 className="mb-4 text-3xl font-bold tracking-tight text-[#f8fafc] md:text-4xl">
            Cara Saya Membangun Perangkat Lunak
          </h2>
          <p className="max-w-3xl text-lg leading-relaxed text-[#cbd5e1]">
            Proses rekayasa yang disiplin, dirancang untuk pengiriman yang andal,
            arsitektur yang bersih, dan sistem yang tetap mudah dirawat seiring
            produk berkembang.
          </p>
        </motion.div>
